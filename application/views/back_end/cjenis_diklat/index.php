    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading ui-draggable-handle">                                
                <h3 class="panel-title">Jenis Diklat</h3>
            </div>
                ...
                <div class="block">
                    ...
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo base_url('back_end/cjenis_diklat/detail'); ?>" class="btn btn-success btn-block">
                                ...
                                <?php if ($records != FALSE): ?>
                                    <?php foreach ($records as $key => $record): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo beautify_str($record->jenis_diklat) ?>
                                            </td>
                                            <td>
